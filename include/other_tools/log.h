...
#define sl_logger_info(text,...) (sl_logger_log_info(text, __func__, __LINE__, __FILE_NAME__, ##__VA_ARGS__)) 
#define sl_logger_error(text,...) (sl_logger_log_error(text, __func__, __LINE__, __FILE_NAME__, ##__VA_ARGS__)) 
